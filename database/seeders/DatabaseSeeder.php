...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Award::insert([
            ...
            ['title' => 'Best School Award - District', 'description' => 'Awarded best school in the district for academic excellence.', 'recipient_name' => 'JMPSSS', 'recipient_class' => null, 'year' => 2024, 'category' => 'Institutional', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ...
        Testimonial::insert([
            ['name' => 'Mrs. Anitha Suresh', 'designation' => 'Parent of Grade VIII student', 'content' => 'JMPSSS has transformed my child with strong academics and discipline. Teachers are approachable and the school environment is safe and encouraging.', 'rating' => 5, 'type' => 'parent', 'passing_year' => null, 'is_featured' => true, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
