    ...
    <style>
        ...
        *::after {
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 4px rgba(0, 72, 0, 0.1);
        }
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 12px 30px rgba(0, 72, 0, 0.35);
        }
...
<body>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" id="password" name="password"
                        class="form-control @error('password') error-field @enderror" placeholder="Enter your password"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('form[action="{{ route('admin.login.post') }}"]').validate({
                rules: {
                ...
                messages: {
                    email: { 
                        ...
                        email: "<i class='fas fa-exclamation-circle'></i> Please enter a valid email format" 
                    },
                    password: { 
                        required: "<i class='fas fa-exclamation-circle'></i> Please enter your password" 
                    }
                },
                errorElement: 'div',
